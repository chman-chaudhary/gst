...
const ViewPurchaseInvoiceDetails = ({
  vendorInfo,
  invoiceDetails,
  productRows,
  totals,
    ...
    <div className="px-10 py-5 space-y-5 w-full">
      ...
      <div>
        <div className="block lg:flex gap-4">
          ...
          <CustomerInformationCard vendorInfo={vendorInfo} />
        ...
        <Card className="space-y-8">
          ...
          <div className="flex justify-end items-center pb-5 px-5">
            <Link href={"/dashboard/purchase-invoice"}>
              <Button>
                <ChevronLeft /> Back
              </Button>
            </Link>
...
export default ViewPurchaseInvoiceDetails;

const CustomerInformationCard = ({ vendorInfo }) => (
  <Card className="w-full lg:w-2/5 mb-5">
    <CardContent className="p-3 space-y-5">
      ...
      <InputField
        label="M/S"
        value={vendorInfo.vendorId.companyName}
        readOnly
      />
      ...
      <InputField
        ...
        type="textarea"
        value={(() => {
          const address = vendorInfo.vendorId.billingAddress;
          return (
            address.address1 +
            ", " +
      ...
      <div className="grid grid-cols-3 gap-3">
        ...
        <Select value={vendorInfo.revCharge} readOnly>
